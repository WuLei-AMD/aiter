...
def _fused_rms_fp8_per_tensor_static_quant_kernel(
    ...
    norm1, rsigma_val = _rmsmorm_op(inp1, w1, inp1_n_cols, eps1)
    ...
    if HAVE_SECOND_INPUT:
        ...
        norm2, _ = _rmsmorm_op(inp2, w2, inp2_n_cols, eps2)
        tl.store(
...
def _fused_rms_fp8_group_quant_kernel(
    ...
    norm1, _ = _rmsmorm_op(inp1, w1, inp1_n_cols, eps1)
